...
def main():
    ...
    ir_a(Robot, GyrS, 300, 0, 200)
    wait(1000)
    ir_a(Robot, GyrS, 650, -196, 300)
    wait(1000)
    
    d = 0

    ir_a(Robot, GyrS, 590, -385, 600)
    wait(1000)
    ir_a(Robot, GyrS, 725, -4, 800)
    wait(1000)
    ...
    wait(1000)
    ir_a(Robot, GyrS, 980, -240, 890)
    wait(1000)
    Arm.run_angle(200, 160)  # Gira 90 grados a 200 grados/segundo
    ir_a(Robot, GyrS, 950, -200, 890)
    wait(1000)
    
    ir_a(Robot, GyrS, 1000, -220, 890)
    wait(1000)
    
    Arm.run_angle(200, -60)
    wait(1000)
    Arm.run_angle(200, 30)
    wait(1000)"""
    #Arm.run_angle(250, 60)
    #wait(1000)
    global x, y, theta
    x, y, theta = 0, 0, 0    
    
    ir_a(Robot, GyrS, 700, 200, 300)
    wait(1000)

    girar_con_gyro(Robot, GyrS, 90, 100)
    wait(1000)

    ir_a(Robot, GyrS, 600, 800, 300)
    wait(1000)
    Arm.run_angle(250, 70)
    wait(1000)
